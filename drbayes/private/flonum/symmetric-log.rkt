...
(define flonum->flprob (make-flprob-fun flonum->flprob/error))
(define flonum->flprob/rndd (make-flprob-fun/rndd flonum->flprob/error))
(define flonum->flprob/rndu (make-flprob-fun/rndu flonum->flprob/error))
